/*
  ...
  1. New Questions
    - Add 10 new questions with their respective alternatives
    - Questions cover various subjects including Constitutional Law, Portuguese, Administrative Law, etc.
    - Each question includes proper metadata (discipline, topic, difficulty, etc.)

  2. Data Organization
    - Questions are properly categorized by discipline
    - Alternatives are ordered correctly
    - All questions are marked as approved and authored by system user
*/
